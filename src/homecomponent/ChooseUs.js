...
function ChooseUs() {
  const listItems = [
    { id: 1, icon: 'fa-solid fa-medal', title: 'Supreme Quality', content: 'Sunrise marine services and trading sets the bar high, as we perform our duties and work to the best of our ability, making sure we exceed the standards set forth by the clients.' },
  ...
  return (
    <div id="choose">
      <div className="choose-content">
        ...
        <p>
          Sunrise marine services and trading is one of the leading companies, that specializes in the Marine Service Contractor that provides Marine Construction. Obtaining and maintaining certification by the International Diving Contractors Association. Sunrises is committed to provide world-class services that meet or exceed safety and environmental requirements as well as, customers expectations, and to conduct its operations in a manner that upholds Safety, Health, Quality, and Environment; both to property and human alike. SUNRISE's commitment to providing its customers with the most reliable resources is reflected in its efforts to obtain the highest standards of independent assessment of its skills.
        </p>
      </div>
